...
class CPU:
    ...
    def step(self, in1, in2):
        ...
        if opcode == 0x0:
            ...
            data_bus = self.ram[operand]
        elif opcode == 0x6:
            data_bus = self.reg_a
        elif opcode == 0x7:
            data_bus = operand
        elif opcode == 0x8:
            data_bus = (~(self.reg_a & operand)) & 0xFF
        else:
            data_bus = 0
        ...
        if opcode == 0x0:
            ...
            self.eq_flag = 1 if (self.reg_a == operand) else 0
